    ...
    if ((t && typeof t == 'object') || typeof t == 'function')
        for (let e of yi(t))
            !pi.call(n, e) &&
                ...
                rn(n, e, {
                    get: () => t[e],
                    enumerable: !(i = Mi(t, e)) || i.enumerable,
                });
    return n;
};
var de = (n, t, s) => (
    ...
    Di(
        t || !n || !n.__esModule
            ? rn(s, 'default', { value: n, enumerable: !0 })
            : s,
        n
    )
);
        ...
        function l(_) {
            ...
            for (
                ...
                var S = p[T],
                    ...
                    z = $ && $[0],
                    I = $ && $[1];
                p[T] = I ? { regex: z, parser: I } : S.replace(/^\[|\]$/g, '');
            }
            return function (q) {
...
var Le = function (t, s, i) {
    ...
    Mn = { s: Le, z: vi, m: gi, a: Si, p: bi, u: ki };
var fe = 'en',
    ue = {};
ue[fe] = hn;
var yn = '$isDayjsObject',
    ve = function (t) {
        return t instanceof he || !!(t && t[yn]);
    },
    ce = function n(t, s, i) {
        var e;
        if (!t) return fe;
        ...
        return (
                ...
                var r = this,
                    ...
                    d = function (k, T) {
                        ...
                        return A.w(
                            r
                                .toDate()
                                [k].apply(r.toDate('s'), (u ? S : $).slice(T)),
                            r
                        );
                    },
                    f = this.$W,
            ...
            (t.format = function (i) {
                ...
                var u = i || fn,
                    ...
                    _ = r.meridiem,
                    h = function (S, $, z, I) {
                        return (S && (S[$] || S(e, u))) || z[$].slice(0, I);
                    },
                    D = function (S) {
                        return A.s(o % 12 || 12, S, '0');
                    },
                    p =
                        _ ||
                        function (T, S, $) {
                ...
                return u.replace(mn, function (T, S) {
...
function Ti({
    ...
    return {
        ...
        months: [],
        init: function () {
            O.locale(di[i] ?? di.en), (this.focusedDate = O().tz(u));
            let a =
