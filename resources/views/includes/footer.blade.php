    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-black footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="container-fluid copyright">
            <div class="container">
                <div class="row">
                    <div class="col text-center text-md-center mb-3 mb-md-0">
                        &copy; <a href="{{ route('home') }}">Anshor Yatim & Dhuafa</a>, All Right Reserved.
                    </div>
