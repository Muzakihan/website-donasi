                    ...
                    <div class="h-100 bg-secondary p-5">
                        <form method="post" action="{{ route('donate.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <select id="products_id" name="products_id" class="form-control bg-light border-0"
                                ...
                                <div class="col-12">
                                    <div class="btn-group d-flex justify-content-around">
                                        ...
                                        <input type="radio" class="btn-check" name="donate_price" value="20000"
                                            id="donate_price2">
                                        <label class="btn btn-light py-3" for="donate_price2">Rp.20.000</label>

                                        <input type="radio" class="btn-check" name="donate_price" value="30000"
                                            id="donate_price3">
